...
public class ItemDatabaseServiceTests : IDisposable
{
    ...
    public async Task UpsertItemAsync_CreatesFileAndStampsLastUpdated()
    {
        ...
        var helm = new EquipmentItem { Name = "Rage of Harrogath", Rarity = ItemRarity.Unique, ItemPower = 800 };
    ...
    {
        var oldHelm = new EquipmentItem { Name = "Old Helm", Rarity = ItemRarity.Rare, ItemPower = 500 };
        await _sut.UpsertItemAsync("MyBarb", "helm", oldHelm, characterClass: "Barbarian");

        var newHelm = new EquipmentItem { Name = "Rage of Harrogath", Rarity = ItemRarity.Unique, ItemPower = 800 };
    ...
    public async Task RoundTrip_WrittenFileMatchesSchemaShape()
    {
        var helm = new EquipmentItem
        {
            ...
            ItemPower = 800,
            Affixes = new List<string> { "+40% Fury Generation" },
            Aspect = null
        };
        ...
        Assert.Equal(JsonValueKind.Null, helmElement.GetProperty("aspect").ValueKind);
    }
}
